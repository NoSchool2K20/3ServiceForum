...
var MessagesForFront$ReasonReactExamples = require("./MessagesForFront.bs.js");
...
function getRowCount(message) {
  return message[/* rowCount */1];
}

function getRows(message) {
  return message[/* rows */2];
}

function fromJson(json) {
  var partial_arg = MessagesForFront$ReasonReactExamples.MessagesForFront.fromJson;
  return /* record */[
