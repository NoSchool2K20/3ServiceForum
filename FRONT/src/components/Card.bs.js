                          ...
                          style: message
                              ...
                              style: container
                                ...
                                onClick: (function (ev) {
                                    ...
                                    fetch("http://127.0.0.1:8080/like", Fetch.RequestInit[/* make */0](/* Post */2, {
                                ...
                                onClick: (function (ev) {
                                    ...
                                    payload["idMessage"] = Caml_format.caml_int_of_string(idmessage);
                                    payload["userId"] = utilisateur;
                                    fetch("http://127.0.0.1:8080/like", Fetch.RequestInit[/* make */0](/* Delete */4, {
                                                  "Content-Type": "application/json"
                                                }, Caml_option.some(JSON.stringify(payload)), undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined)(/* () */0)).then((function (prim) {
                                            return prim.json();
                                          }));
                                ...
                                style: trash,
                                alt: "",
                                src: TrashJpg.default,
                                onClick: (function (ev) {
                                    var payload = { };
                                    payload["idMessage"] = Caml_format.caml_int_of_string(idmessage);
                                    fetch("http://127.0.0.1:8080/message", Fetch.RequestInit[/* make */0](/* Delete */4, {
                                                  "Content-Type": "application/json"
                                                }, Caml_option.some(JSON.stringify(payload)), undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined)(/* () */0)).then((function (prim) {
                                            return prim.json();
                                          }));
